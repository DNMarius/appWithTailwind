    ...
    return (
        <div className="p-3 rounded-lg flex w-[310px] items-center border hover:shadow-md Cathegorie">
            ...
            <div className="px-4">
                ...
                <p className="mt-[8px]">{props.children[2]}</p>
            </div>
        </div>
    );
}

export default function JobCathegories() {
    return (
        <div className="grid grid-cols-3 gap-8 JobCathegories">
            ...
            <Cathegorie>
                ...
                <h2>Human Ressource</h2>
                <p>(55 opened options)</p>
            </Cathegorie>
            <Cathegorie>
                {/* prettier-ignore */}
